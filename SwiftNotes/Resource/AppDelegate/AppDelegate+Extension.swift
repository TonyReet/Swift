...
extension AppDelegate {
    func initRootViewController(isLogin:Bool? = true) {
        ...
        itemArray.append(BaseTabbarItemModel.init(name: "其他", imgNormalName: Iconfont.folderNormal.rawValue,imgHighlighName: Iconfont.folderSelect.rawValue, viewControllerName: "BasicViewControler"))
